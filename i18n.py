...
MESSAGES: Dict[str, Dict[str, str]] = {
    "tr": {
        ...
        "menu_update": "[11] Guncellemeleri Denetle ve Yukle (GitHub)",
        "menu_lang": "[12] Dil Secimi / Language Selection (TR / EN)",
        "menu_exit": "[0] Cikis",
        ...
        "checking_updates": "[BILGI] GitHub uzerinden guncellemeler denetleniyor...",
        "update_available": "[GUNCELLEME] Yeni bir surum mevcut ({count} yeni guncelleme)!",
        "update_not_available": "[BILGI] Uygulamaniz guncel! (En son surumu kullaniyorsunuz)",
        "update_success": "[BASARILI] Uygulama basariyla guncellendi! (Yeni Surum: {version})",
        "update_failed": "[HATA] Guncelleme yapilamadi: {error}",
    ...
    "en": {
        ...
        "menu_update": "[11] Check & Install Updates (GitHub)",
        "menu_lang": "[12] Dil Secimi / Language Selection (TR / EN)",
        "menu_exit": "[0] Exit",
        ...
        "checking_updates": "[INFO] Checking for updates on GitHub...",
        "update_available": "[UPDATE] A newer version is available ({count} new commits)!",
        "update_not_available": "[INFO] Your application is up to date! (Using the latest version)",
        "update_success": "[SUCCESS] Application updated successfully! (New Version: {version})",
        "update_failed": "[ERROR] Failed to apply update: {error}",
